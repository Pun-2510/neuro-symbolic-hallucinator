# Progress Notes — Weekly Session Recaps

Thư mục này chứa các file **session summary / weekly recap** cho từng giai đoạn làm việc. Mục đích:

- **Tracking tiến độ** theo từng tuần (v1.2 §5.2 roadmap 18 tuần).
- **Recap quyết định kỹ thuật** + các test fail còn lại + cách workaround.
- **Handover** giữa các phiên làm việc / giữa 2 SV.

Các file trong thư mục:

| File | Ngày | Tuần | Nội dung |
|---|---|---|---|
